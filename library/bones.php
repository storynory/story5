...
function bones_scripts_and_styles() {
  ...
  if (!is_admin()) {
    ...
    wp_register_script( 'bones-modernizr', get_stylesheet_directory_uri() . '/library/js/modernizr.js', array(), '2.5.3', false );
 ...
 //adding scripts file in the footer
    wp_register_script( 'range', get_stylesheet_directory_uri() . '/library/js/rangeslider.js', array( 'jquery' ), '', true );

    //adding scripts file in the footer
    wp_register_script( 'scripts', get_stylesheet_directory_uri() . '/library/js/scripts.js', array( 'jquery' ), '', true );
 //adding scripts file in the footer
    wp_register_script( 'perfBar', get_stylesheet_directory_uri() . '/library/js/perfbar.js', array( 'jquery' ), '', true );
...
function bones_main_nav() {
    ...
    wp_nav_menu(array(
    	...
    	'menu_class' => 'nav nav--top',         // adding custom nav class
		...
		'walker' => new Selective_Walker()                  // adds class "drop-down" to items that have them - added by hugh
	));
} /* end bones main nav */
...
function bones_main_nav_fallback() {
	wp_page_menu( array(
		'show_home' => true,
    	'menu_class' => 'nav top-nav hugh clearfix',      // adding custom nav class
		'include'     => '',
		'exclude'     => '',
		'echo'        => true,
        'link_before' => '',                            // before each link
